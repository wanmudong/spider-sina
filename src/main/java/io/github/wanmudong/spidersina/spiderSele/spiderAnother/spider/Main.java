...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException, SQLException, ClassNotFoundException {
        ...
        int page=1;
        int i = ra.nextInt(10);
//        for (int i = 0; i < webDrivers.length-9; i++) {
...
//            String orginUrl = "https://m.weibo.cn/u/";
...
//        weiBoSpider.start(linsiyi);
        ...
        int j = 0;
        while (true) {
            String weiboId = "HrVmp5ma1";
            boolean success = false;
            try {
                CommentSpider commentSpider = new CommentSpider(webDrivers[i], weiboId,page);
